...
public class DBOpenHelper extends SQLiteOpenHelper{
    ...
    private String createPersonTable = "Create table person (personId varchar(64) primary key on conflict replace, nick varchar(64), location varchar(64), gender integer, avatar varchar(64), age integer)";
